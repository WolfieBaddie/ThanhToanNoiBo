...
import ActivityFeed from "@/admin/page/dashboard/components/ActivityFeed.tsx";
import QuickActions from "@/admin/page/dashboard/components/QuickActions.tsx";
...
const AdminDashboard: FC = () => {
  ...
  const renderContent = () => {
    switch(activeTab) {
      ...
      case 'services': return <ServicesTable />;
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen backdrop-blur-xl">
